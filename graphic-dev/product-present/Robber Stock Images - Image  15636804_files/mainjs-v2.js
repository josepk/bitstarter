...
search_normal=!$('#s_st').is(':checked') && $('#s_ph').is(':checked') && $('#s_il').is(':checked') && !$('#s_ad').is(':checked');
...
if ($('.dt-adv-search').html()!=null && $('.dt-first-search').html()!=null)
	...
	{
	searchgg=sh.value.split(" ").join("-");
	window.location="/photos-images/"+searchgg+".html";
	return false;
	}
	else return;
}
...
function AddImage() {
	var image_url = prompt(dtl_AddImage_000, 'http://www.');
...
function AddImageLeft() {
	var image_url = prompt(dtl_AddImageLeft_000, 'http://www.');
	if (image_url != null) { insertAtCursor(document.frm_forum.message,'[imgl]' + image_url + '[/imgl]'); }
}
function AddImageRight() {
	var image_url = prompt(dtl_AddImageRight_000, 'http://www.');
...
function AddURLB() {
	var link_url = prompt(dtl_AddURLB_000, 'http://www.');
...
function AddURL() {
	var link_url = prompt(dtl_AddURL_000, 'http://www.');
