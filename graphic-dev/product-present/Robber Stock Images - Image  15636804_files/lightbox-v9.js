    ...
    $thb_c23.each(function() {
      ...
      if (pageVersion == 2) {
        ...
        if (lightbox_vars.images_info[id]) {
          $("#class_thb_c23" + id).addClass("thb_c23_rmv").attr('title', lightbox_vars.remove_from_lightbox);
          if (width && width > 50) {
          ...
          $("#bigthumb" + id).animate({opacity: 0.3}, 'slow');
        } else {
          $("#class_thb_c23" + id).removeClass("thb_c23_rmv thb_c23_rmv_on").attr('title', lightbox_vars.add_to_lightbox);
          if (width && width > 78) {
          ...
          $("#bigthumb" + id).animate({opacity: 1}, 'slow');
        }
      }
    });
    if (pageVersion == 1) {
